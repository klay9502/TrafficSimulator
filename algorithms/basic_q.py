...
class BasicQ:
    ...
    def update_table(self, now_time, now_signal, alpha, gamma):
        total_discomfort_value = np.sum(self.now_total_discomfort_value)
    ...
    def set_now_total_discomfort_value(self, now_total_discomfort_value):
        self.now_total_discomfort_value = now_total_discomfort_value
